...
> ℹ️ **B7 was never filed under its own name — but its defect is reported, as N6.**
> Verified 2026-09-23 by fingerprinting all 25 filed reports by content: the only
> recurring-bill report is N6 (`5d6a7f61-fed9-4ad7-b430-31b52595f15c`), which covers
> the India instance *and* names Keystone. **Do not file B7 separately — it would
> duplicate N6.** N1–N8 are all filed. Genuinely unfiled: only B8, B9 and B5.
> See `agentswitch_submissions.md` §C.
